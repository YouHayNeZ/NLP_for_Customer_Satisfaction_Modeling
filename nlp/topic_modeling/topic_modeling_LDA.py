...
def lda_topic_modeling(df, column, num_topics=5):
    ...
    dtm = vectorizer.fit_transform(df[column])
    ...
    for i in range(num_topics):
        df[f"Topic_{i+1}_probability"] = topic_assignments[:, i]
    ...
    df['Max_Probability_Topic'] = max_topic_names
