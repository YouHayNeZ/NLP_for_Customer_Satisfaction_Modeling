...
def main():
    ...
    y_test2 = y_test + 1
    pd.DataFrame({'Predicted Overall Rating': y_pred_unweighted, 'Real Overall Rating': y_test2, 'Date Published': datetime_test['Date Published']}).set_index('Date Published').to_csv('outputs/predictive_modeling/classification/ensemble/ensemble_unweighted_test_preds.csv')
    ...
    pd.DataFrame({'Predicted Overall Rating': y_pred_weighted, 'Real Overall Rating': y_test2, 'Date Published': datetime_test['Date Published']}).set_index('Date Published').to_csv('outputs/predictive_modeling/classification/ensemble/ensemble_weighted_test_preds.csv')
